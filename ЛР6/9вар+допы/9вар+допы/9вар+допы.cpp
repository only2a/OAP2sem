// 9вар+допы.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void insert1(list3*&, char);
double del1(list3*&, char);
void find1(list3*, char);
...
void mainTask1(list3*&);
void extraTaskVar10(list*);
void extraTaskVar11(list3*);
void extraTaskVar12(list2*);
...
double del1(list*& p, int value)  // Удаление числа 
{
...
void insert1(list3*& p, char value) //Добавление числа value в список 
{
...
double del1(list3*& p, char value)  // Удаление числа 
{
